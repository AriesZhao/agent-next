...
class ErrorCode(StrEnum):
    ...
    DATA_SOURCE_NAME_TAKEN = "DATA_SOURCE_NAME_TAKEN"
    DATA_SOURCE_NAME_INVALID = "DATA_SOURCE_NAME_INVALID"
    DATA_SOURCE_ENGINE_UNSUPPORTED = "DATA_SOURCE_ENGINE_UNSUPPORTED"
    DATA_SOURCE_MODEL_NOT_CONFIGURED = "DATA_SOURCE_MODEL_NOT_CONFIGURED"
...
_DEFAULT_STATUS: dict[ErrorCode, int] = {
    ...
    ErrorCode.DATA_SOURCE_FORBIDDEN: 403,
    ErrorCode.DATA_SOURCE_LIMIT: 409,
    ErrorCode.DATA_SOURCE_NAME_TAKEN: 409,
    ErrorCode.DATA_SOURCE_NAME_INVALID: 400,
    ErrorCode.DATA_SOURCE_ENGINE_UNSUPPORTED: 400,
    ErrorCode.DATA_SOURCE_MODEL_NOT_CONFIGURED: 409,
    ErrorCode.DATA_SOURCE_CONNECTION_FAILED: 502,
